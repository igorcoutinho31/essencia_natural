...
<script src="/assets/js/menu.js?v=20260924-2"></script>
<script src="/assets/js/atendimento.js?v=20260924-2"></script>
<script src="/assets/js/sacola.js?v=20260924-2"></script>
<script src="/assets/js/vida.js?v=20260924-2"></script>
<script>
  (function(){
...
<link rel="stylesheet" href="/assets/css/site.css?v=20260924-2">
<link rel="stylesheet" href="/assets/css/product.css?v=20260924-2">
</head>
<body>
${body}
</body>
...
function productPage(req, res, slug) {
  ...
  if (!product) {
    sendHTML(res, 404, `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><title>Produto não encontrado — ${SITE_NAME}</title><meta name="robots" content="noindex"><link rel="stylesheet" href="/assets/css/site.css?v=20260924-2"></head><body style="padding:80px 24px;text-align:center;background:#0b0906;color:#f4ecd8;font-family:sans-serif"><h1>Produto não encontrado</h1><p><a href="/#catalogo" style="color:#c9a44c">Voltar para o catálogo</a></p></body></html>`);
    return;
  }
